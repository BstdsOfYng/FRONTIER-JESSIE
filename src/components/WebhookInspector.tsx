...
import { Radio, Copy, CheckCircle2, Play, RefreshCw, Trash2, Code2 } from 'lucide-react';
      ...
      <div className="bg-[#050505] border border-[#1a1a1a] rounded-xl p-6 shadow-2xl relative overflow-hidden">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center space-x-2">
            <motion.button
              ...
              disabled={isPinging}
              className="px-3.5 py-2 text-xs font-mono font-bold bg-[#141414] hover:bg-[#1a1a1a] text-cyan-400 border border-cyan-500/30 rounded-md transition-all shadow-md flex items-center space-x-1.5 disabled:opacity-50 uppercase tracking-wider cursor-pointer"
            >
        ...
        <div className="mt-4 bg-[#080808] p-3.5 rounded-lg border border-[#1a1a1a] flex items-center justify-between font-mono text-xs text-cyan-300">
          ...
          <motion.button
            ...
            className="px-3 py-1.5 bg-[#141414] hover:bg-[#1a1a1a] text-[#dcdcdc] rounded text-xs font-mono font-medium transition-colors shrink-0 flex items-center space-x-1 border border-white/10 cursor-pointer"
          >
            {copiedUrl ? (
              <>
          ...
          <div className="flex items-center justify-between border-b border-[#1a1a1a] pb-3 px-1">
            ...
            <div className="flex items-center space-x-1">
              <motion.button
                ...
                className="p-1.5 text-[#a1a1aa] hover:text-white hover:bg-[#141414] rounded transition-colors cursor-pointer"
              ...
              <motion.button
                ...
                className="p-1.5 text-[#a1a1aa] hover:text-red-400 hover:bg-[#141414] rounded transition-colors cursor-pointer"
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between pt-1 border-t border-[#1a1a1a]">
                      ...
                      <motion.button
                        ...
                        className="px-2.5 py-1 text-[10px] font-mono font-bold bg-[#4ade80]/10 hover:bg-[#4ade80]/20 text-[#4ade80] border border-[#4ade80]/30 rounded transition-colors flex items-center gap-1 uppercase tracking-wider cursor-pointer"
                      >
